...
def visualize_time_data_in_dot_and_whisker_plot(
        csv_path : str,
        ylabel : str,
        y_val : str,
        colors : list,
    ...
    Plots the specified feature, aggregated by mouseType into dot and whisker plot.
    ...
    # df.rename(columns={TIME_FRACTION_BY_QUADRANT : f"{TIME_FRACTION_BY_QUADRANT}1",
    #                    "Unnamed: 5": f"{TIME_FRACTION_BY_QUADRANT}2",
    #                    "Unnamed: 6": f"{TIME_FRACTION_BY_QUADRANT}3",
    #                    "Unnamed: 7": f"{TIME_FRACTION_BY_QUADRANT}4", 
    #                    DISTANCE_BY_INTERVALS : f"{DISTANCE_BY_INTERVALS}1", 
    #                    "Unnamed: 9": f"{DISTANCE_BY_INTERVALS}2",
    #                    "Unnamed: 10": f"{DISTANCE_BY_INTERVALS}3",
    #                    "Unnamed: 11": f"{DISTANCE_BY_INTERVALS}4",
    #                    "Unnamed: 12": f"{DISTANCE_BY_INTERVALS}5", 
    #                    "Unnamed: 13": f"{DISTANCE_BY_INTERVALS}6", 
    #                    }, inplace=True)
